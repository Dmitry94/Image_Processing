...
def main():
    images, labels = captcha_inputs.inputs(
        "images/train", MIN_AFTER_DEQUEUE)
    validation_images, validation_labels = captcha_inputs.inputs(
        "images/validation", VALIDATION_MIN_AFTER_DEQUEUE)
